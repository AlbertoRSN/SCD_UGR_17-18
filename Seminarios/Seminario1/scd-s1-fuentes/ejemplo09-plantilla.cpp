...
//Variables globales
const long m  = 1024l*1024l*1024l,  //Numero de muestras
           n  = 4 ;                 //Numero de hebras


//Desde 0 hasta m-1 se divide entre el numero de hebras para ver que hace cada hebra
// ----------------------------------------------------------------------------
...
int main()
{
    // declarar el array de variables de tipo future future<long> futuros[num_hebras] ;
